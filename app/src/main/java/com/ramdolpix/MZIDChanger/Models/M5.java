...
public class M5 {
    public static String checkID() {
        ...
        try {
            ...
            Process process = Runtime.getRuntime().exec("cat /dev/block/mmcblk0p15");
    ...
    public static void changeID2China(){
        sudo("mount -o rw,remount /dev");
        sudo("echo -e '0' | dd of=/dev/block/mmcblk0p15 bs=1 seek=517 count=1");
        sudo("echo -e '1' | dd of=/dev/block/mmcblk0p15 bs=1 seek=521 count=1");
    }
}
