...
public class M6 {
    public static String checkID() {
        ...
        try {
            ...
            Process process = Runtime.getRuntime().exec("cat /dev/block/mmcblk0p8");
    ...
    public static void changeID2China(){
        sudo("mount -o rw,remount /dev");
        sudo("echo -e '0' | dd of=/dev/block/mmcblk0p8 bs=1 seek=515 count=1");
        sudo("echo -e '1' | dd of=/dev/block/mmcblk0p8 bs=1 seek=519 count=1");
    }
}
